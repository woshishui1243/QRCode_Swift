...
s.name          = 'QRCodeCopy'
s.version       = '1.0.0'
s.summary       = 'QRCodeCopy in Swift'
s.description   = <<-DESC
    QRCode in Swift  V1
DESC
s.homepage     = "https://github.com/woshishui1243/QRCodeCopy.git"
s.license      = { :type => 'MIT', :file => 'LICENSE' }
s.author             = { "DaYu" => "dayu_0518@163.com" }
s.platform     = :ios, "8.0"
s.source       = { :git => "https://github.com/woshishui1243/QRCodeCopy.git", :tag => s.version}
